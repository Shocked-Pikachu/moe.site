...
&= A^{k_1}_{i_1'} \cdots A^{k_r}_{i_r'} A_{l_1}^{j_1'} \cdots A_{l_s}^{j_s'} {T_{k_1,\dots,k_r}}^{l_1,\dots,l_s}
\end{align*}
$$
...
\boxed{
\begin{align*}
T={T_{i_1,...,i_r}}^{j_1,...,j_s}e^{i_1}\otimes \cdots e^{i_r}\otimes e_{j_1}\otimes\cdots \otimes e_{j_s}
\end{align*}}
$$
